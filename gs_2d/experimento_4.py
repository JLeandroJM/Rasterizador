"""
Experimento 4: pipeline completo (clone + split + prune).

Anadimos prune cada 100 pasos: eliminamos gaussianas con opacidad muy baja
(< 0.005) o con escala enorme (> 50% del lado de la imagen).
"""
import os
import sys
import time
...
def main():
    ...
    salida = os.path.join(os.path.dirname(os.path.abspath(__file__)), "salidas_exp4")
    ...
    for it in range(iteraciones):
        ...
        # NUEVO: pruning cada prune_interval pasos
    ...
    guardar_curva(n_gauss_historial, "# gaussianas (con pruning)", "N", os.path.join(salida, "n_gaussianas.png"))
